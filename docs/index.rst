...
require very little curation and can in fact be left running indefinitely.
...
that performs exactly this determination, using your user's interaction as its "pulls"
...
will register how much "reward" the arm has paid.  These values are persisted to the client so users can keep a consistent
...
* Changing add copy wording or help text to see if it increases click throughput
